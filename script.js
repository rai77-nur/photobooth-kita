...
const CUSTOM_TEMPLATES = {
    ...
    "custom-baby-girl": { slots: [
        { x: 0.4620, y: 0.2973, w: 0.3075, h: 0.1741, angle: -4.14 },
        { x: 0.4875, y: 0.4889, w: 0.3096, h: 0.1744, angle: -4.18 },
        { x: 0.5125, y: 0.6808, w: 0.3113, h: 0.1742, angle: -4.13 }
    ]},
    "custom-bingkai": { slots: [
        { x: 0.2958, y: 0.2063, w: 0.4107, h: 0.1558, angle: -7.33 },
    ...
    "custom-bingkai6": { slots: [
        ...
        { x: 0.5438, y: 0.0990, w: 0.3579, h: 0.2141, angle: 7.13 },
        { x: 0.0000, y: 0.4817, w: 0.2486, h: 0.2118, angle: 0.00 },
        { x: 0.2652, y: 0.3073, w: 0.4379, h: 0.3662, angle: 1.19 },
        { x: 0.0074, y: 0.7315, w: 0.3903, h: 0.1975, angle: -6.93 },
        { x: 0.5771, y: 0.6005, w: 0.3656, h: 0.2948, angle: 8.87 }
    ]},
    "custom-camera": { slots: [
        { x: 0.1126, y: 0.0600, w: 0.6563, h: 0.2308, angle: 0.00 },
        { x: 0.2193, y: 0.3977, w: 0.5959, h: 0.2100, angle: 2.99 },
        { x: 0.2385, y: 0.7008, w: 0.6563, h: 0.2308, angle: 0.00 }
    ]},
    "custom-camera2": { slots: [
        { x: 0.3217, y: 0.2664, w: 0.3915, h: 0.1697, angle: 0.29 },
        { x: 0.3207, y: 0.4549, w: 0.3913, h: 0.1697, angle: 0.00 },
        { x: 0.3193, y: 0.6445, w: 0.3913, h: 0.1705, angle: 0.00 }
    ]},
    "custom-memory-book": { slots: [
        { x: 0.2123, y: 0.1349, w: 0.5425, h: 0.2150, angle: -18.76 },
        { x: 0.1951, y: 0.4156, w: 0.5574, h: 0.2211, angle: 2.12 },
        { x: 0.2011, y: 0.6960, w: 0.5470, h: 0.2171, angle: 18.26 }
    ]},
    "custom-bingkai7": { slots: [
        { x: 0.0482, y: 0.0025, w: 0.4181, h: 0.2380, angle: -26.04 },
        { x: 0.0441, y: 0.3465, w: 0.4412, h: 0.2508, angle: 33.35 },
        { x: 0.0360, y: 0.7186, w: 0.4556, h: 0.2617, angle: -19.48 },
        { x: 0.6440, y: 0.0199, w: 0.3220, h: 0.1797, angle: 0.00 },
        { x: 0.6440, y: 0.2141, w: 0.3207, h: 0.1804, angle: 0.00 },
        { x: 0.6427, y: 0.4083, w: 0.3220, h: 0.1804, angle: 0.00 },
        { x: 0.6427, y: 0.6032, w: 0.3207, h: 0.1797, angle: 0.00 }
    ]}
};
