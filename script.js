...
const CUSTOM_TEMPLATES = {
    ...
    "custom-bingkai6": { frameInset: 0, slots: [
        ...
        { x: 0.1587, y: 0.3672, w: 0.6508, h: 0.2464, angle: -88.81 },
        { x: 0.0074, y: 0.7315, w: 0.3903, h: 0.1975, angle: -6.93 },
        { x: 0.4980, y: 0.6451, w: 0.5239, h: 0.2057, angle: -81.13 }
    ]},
    "custom-camera": { slots: [
    ...
    "custom-bingkai7": { slots: [
        ...
        { x: 0.0418, y: 0.3478, w: 0.4457, h: 0.2482, angle: -56.65 },
        { x: 0.0360, y: 0.7186, w: 0.4556, h: 0.2617, angle: -19.48 },
        { x: 0.6454, y: 0.0191, w: 0.3193, h: 0.1812, angle: -90.00 },
        { x: 0.6440, y: 0.2141, w: 0.3207, h: 0.1804, angle: -90.00 },
        { x: 0.6433, y: 0.4079, w: 0.3207, h: 0.1812, angle: -90.00 },
        { x: 0.6433, y: 0.6028, w: 0.3193, h: 0.1804, angle: -90.00 }
    ]}
};
